class BSTNode:
  ...
  def contadorNosFolhas(self): #Método para retornar a quantidade de nós folhas que a árvore possui.
    if not self.data:
      return 0
      ...
      if self.left:
        esq = self.left.contadorNosFolhas()
      else:
        esq = 0
      if self.right:
        dir = self.right.contadorNosFolhas()
      else:
        dir = 0
      return esq + dir
...
root.insert(22)
root.insert(10)
print("Quantidade de Nós folhas:", root.contadorNosFolhas())
